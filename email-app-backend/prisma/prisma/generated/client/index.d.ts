...
export namespace Prisma {
  ...
  */
  ...
  export type EmailTagOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "messageId" | "tag" | "createdAt", ExtArgs["result"]["emailTag"]>
  ...
  export interface EmailTagDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `id`
     * const emailTagWithIdOnly = await prisma.emailTag.findMany({ select: { id: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many EmailTags and only return the `id`
     * const emailTagWithIdOnly = await prisma.emailTag.createManyAndReturn({
     *   select: { id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more EmailTags and only return the `id`
     * const emailTagWithIdOnly = await prisma.emailTag.updateManyAndReturn({
     *   select: { id: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface EmailTagFieldRefs {
    readonly id: FieldRef<"EmailTag", 'String'>
    readonly messageId: FieldRef<"EmailTag", 'String'>
    readonly tag: FieldRef<"EmailTag", 'String'>
    readonly createdAt: FieldRef<"EmailTag", 'DateTime'>
  }
  ...
  export type TagOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "label" | "emailId" | "createdAt", ExtArgs["result"]["tag"]>
  ...
  interface TagFieldRefs {
    ...
    readonly emailId: FieldRef<"Tag", 'String'>
  ...
  export type EmailTagWhereInput = {
    ...
    id?: StringFilter<"EmailTag"> | string
    messageId?: StringFilter<"EmailTag"> | string
    tag?: StringFilter<"EmailTag"> | string
    createdAt?: DateTimeFilter<"EmailTag"> | Date | string
  }
  ...
  export type EmailTagScalarWhereWithAggregatesInput = {
    ...
    id?: StringWithAggregatesFilter<"EmailTag"> | string
    messageId?: StringWithAggregatesFilter<"EmailTag"> | string
    tag?: StringWithAggregatesFilter<"EmailTag"> | string
    createdAt?: DateTimeWithAggregatesFilter<"EmailTag"> | Date | string
  }
  ...
  export type TagWhereInput = {
    ...
    emailId?: StringFilter<"Tag"> | string
  ...
  export type TagScalarWhereWithAggregatesInput = {
    ...
    emailId?: StringWithAggregatesFilter<"Tag"> | string
